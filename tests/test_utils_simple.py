...
def test_load_dotenv_file_exists():
    ...
    try:
        ...
        assert os.environ.get('TEST_VAR') == 'test_value', f"TEST_VAR is {os.environ.get('TEST_VAR')}, expected 'test_value'"
        assert os.environ.get('ANOTHER_VAR') == 'quoted value', f"ANOTHER_VAR is {os.environ.get('ANOTHER_VAR')}, expected 'quoted value'"
