...
# Run the immediate popup recorder with wtype output
PYTHONWARNINGS=ignore python -m desktopstt.immediate_popup --silence-threshold 0.05 --silence-duration 3.0 --wtype --silent 2>/dev/null
