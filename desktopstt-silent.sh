...
LOG_FILE="/tmp/desktopstt-silent-debug.log"
...
PYTHONWARNINGS=ignore "$DESKTOPSTT_PATH/.venv/bin/python" -m desktopstt.headless_recorder --silence-threshold 0.05 --silence-duration 3.0 --debug > "$OUTPUT_FILE" 2>> "$LOG_FILE"
PYTHON_EXIT_CODE=$?
